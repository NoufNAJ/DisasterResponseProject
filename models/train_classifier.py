...
def load_data(database_filepath):
    ...
    Parameters:
    database_filepath (str): The filepath of the SQL database.
    ...
    df = pd.read_sql_table("MessagesCategoriesTable", engine)
...
def build_model():
   ...
   # Define the machine learning pipeline
    ...
    # Dictionary containing parameters for grid search
    parameters = {'vect__ngram_range': ((1, 1), (1, 2)),  # N-gram range
                    'clf__estimator__n_estimators': [10, 50],  # Number of decision trees
                    'clf__estimator__min_samples_split': [2, 5]  # Minimum samples to split a node
                    } 
